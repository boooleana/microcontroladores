...
unsigned int vector_digits[4]={~0x40,~0x80,~0x04,~0x08}; // sinal baixo funciona
...
unsigned int vector_bolinha[8]={0x9C,0x9C,0x9C,0x9C,0xA3,0xA3,0xA3,0xA3};
unsigned int bolinha_digits[8]={0x40,0x80,0x04,0x08,0x08,0x04,0x80,0x40}; // sinal alto funciona
...
unsigned int j=0,c=0,l=0,pause=1,decimo_segundo=10,first=0;

int d=3,beliche=0,volta=0,sentido=0,i=0,delay_bolinha=10,n1=0,n2=0,n3=0,n4=0;
...
/*void bolinha(int i)
{
    GPIO_escrita(portalE_base, pino0|pino1|pino2|pino3, vector_bolinha[i]);
    GPIO_escrita(portalC_base, pino4|pino5|pino6|pino7, vector_bolinha[i]);
}*/
...
/*
void digito_bolinha(int i)
{
    GPIO_escrita(portalB_base, pino6|pino7, bolinha_digits[i]);
    GPIO_escrita(portalD_base, pino3|pino2, bolinha_digits[i]);
    #ifdef anodo
        GPIO_escrita(portalD_base, pino6,pino6);
    #endif
...
/*
void bolinha_gira(void)
{
    digito_bolinha(i);bolinha(i);
    delay_system(delay_bolinha);
    ...
    if(GPIO_leitura(portalF_base,pino4)!=pino4)
    {
        delay_system(30);
           ...
           //i>7 ? i=0 : i ;
           //i < 0 ? i=7: i ;
           if(i>7) i=0;//chegou no quarto digito
           if(i<0) i=7;//chegou no começo
}*/
